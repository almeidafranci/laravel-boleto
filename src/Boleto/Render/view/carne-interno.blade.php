    ...
    @foreach($boletos as $i => $boleto)
        ...
        <div style="width: 863px">
                ...
                <table class="table-boleto" style="width: 180px" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="conteudo">{{ $periodo }}</div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td class="bottomborder" rowspan="2">
                            <div class="titulo">Pagador</div>
                            <div>{{ $pagador['nome_documento'] }}</div>
                        </td>
                    </tr>
                </table>
            ...
            <div style="float: left; margin-left: 15px">
                ...
                @include('BoletoHtmlRender::partials/ficha-compensacao-interna')
            </div>
